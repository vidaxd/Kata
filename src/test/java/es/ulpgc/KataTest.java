...
public class KataTest {
    ...
    @Test
    public void given_a_char_chain_should_be_return_a_char_chain_tranformed() {
        assertThat(Kata.accum("SigMar")).isEqualTo("S-Ii-Ggg-Mmmm-Aaaaa-Rrrrrr");
    }

    @Test
    public void given_a_upper_case_char_chain_should_be_return_a_char_chain_tranformed() {
        assertThat(Kata.accum("BANKAI")).isEqualTo("B-Aa-Nnn-Kkkk-Aaaaa-Iiiiii");
    }

    @Test
    public void given_a_lower_case_char_chain_should_be_return_a_char_chain_tranformed() {
